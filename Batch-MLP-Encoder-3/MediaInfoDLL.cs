...
namespace MediaInfoLib {
    ...
    public class MediaInfo {
        ...
        ~MediaInfo() { if (this.Handle == (IntPtr)0) return; MediaInfo_Delete(this.Handle); }
        public int Open(String FileName) {
            if (this.Handle == (IntPtr)0)
                return 0;
            if (this.MustUseAnsi) {
                IntPtr FileName_Ptr = Marshal.StringToHGlobalAnsi(FileName);
                int ToReturn = (int)MediaInfoA_Open(this.Handle, FileName_Ptr);
        ...
        public int Open_Buffer_Init(Int64 File_Size, Int64 File_Offset) {
            if (this.Handle == (IntPtr)0) return 0; return (int)MediaInfo_Open_Buffer_Init(this.Handle, File_Size, File_Offset);
        }
        public int Open_Buffer_Continue(IntPtr Buffer, IntPtr Buffer_Size) {
            if (this.Handle == (IntPtr)0) return 0; return (int)MediaInfo_Open_Buffer_Continue(this.Handle, Buffer, Buffer_Size);
        }
        public Int64 Open_Buffer_Continue_GoTo_Get() {
            if (this.Handle == (IntPtr)0) return 0; return (Int64)MediaInfo_Open_Buffer_Continue_GoTo_Get(this.Handle);
        }
        public int Open_Buffer_Finalize() {
            if (this.Handle == (IntPtr)0) return 0; return (int)MediaInfo_Open_Buffer_Finalize(this.Handle);
        }
        public void Close() { if (this.Handle == (IntPtr)0) return; MediaInfo_Close(this.Handle); }
        ...
        public String Get(StreamKind StreamKind, int StreamNumber, String Parameter, InfoKind KindOfInfo, InfoKind KindOfSearch) {
            ...
            if (this.MustUseAnsi) {
                ...
                String ToReturn = Marshal.PtrToStringAnsi(MediaInfoA_Get(this.Handle, (IntPtr)StreamKind, (IntPtr)StreamNumber, Parameter_Ptr, (IntPtr)KindOfInfo, (IntPtr)KindOfSearch));
                Marshal.FreeHGlobal(Parameter_Ptr);
                return ToReturn;
            }
            else
                return Marshal.PtrToStringUni(MediaInfo_Get(this.Handle, (IntPtr)StreamKind, (IntPtr)StreamNumber, Parameter, (IntPtr)KindOfInfo, (IntPtr)KindOfSearch));
        }
        ...
        public int State_Get() { if (this.Handle == (IntPtr)0) return 0; return (int)MediaInfo_State_Get(this.Handle); }
        public int Count_Get(StreamKind StreamKind, int StreamNumber) { if (this.Handle == (IntPtr)0) return 0; return (int)MediaInfo_Count_Get(this.Handle, (IntPtr)StreamKind, (IntPtr)StreamNumber); }
    ...
    public class MediaInfoList {
        ...
        //MediaInfo class
        public MediaInfoList() { this.Handle = MediaInfoList_New(); }
        ~MediaInfoList() { MediaInfoList_Delete(this.Handle); }
        public int Open(String FileName, InfoFileOptions Options) { return (int)MediaInfoList_Open(this.Handle, FileName, (IntPtr)Options); }
        public void Close(int FilePos) { MediaInfoList_Close(this.Handle, (IntPtr)FilePos); }
        public String Inform(int FilePos) { return Marshal.PtrToStringUni(MediaInfoList_Inform(this.Handle, (IntPtr)FilePos, (IntPtr)0)); }
        public String Get(int FilePos, StreamKind StreamKind, int StreamNumber, String Parameter, InfoKind KindOfInfo, InfoKind KindOfSearch) { return Marshal.PtrToStringUni(MediaInfoList_Get(this.Handle, (IntPtr)FilePos, (IntPtr)StreamKind, (IntPtr)StreamNumber, Parameter, (IntPtr)KindOfInfo, (IntPtr)KindOfSearch)); }
        public String Get(int FilePos, StreamKind StreamKind, int StreamNumber, int Parameter, InfoKind KindOfInfo) { return Marshal.PtrToStringUni(MediaInfoList_GetI(this.Handle, (IntPtr)FilePos, (IntPtr)StreamKind, (IntPtr)StreamNumber, (IntPtr)Parameter, (IntPtr)KindOfInfo)); }
        public String Option(String Option, String Value) { return Marshal.PtrToStringUni(MediaInfoList_Option(this.Handle, Option, Value)); }
        public int State_Get() { return (int)MediaInfoList_State_Get(this.Handle); }
        public int Count_Get(int FilePos, StreamKind StreamKind, int StreamNumber) { return (int)MediaInfoList_Count_Get(this.Handle, (IntPtr)FilePos, (IntPtr)StreamKind, (IntPtr)StreamNumber); }
        private IntPtr Handle;
